...
class Tests(unittest.TestCase):
    def test_single_outbound_delta(self):
        c = {'outbounds': [{'tag': 'neighbor', 'settings': {'x': 1}}, {'tag': 'exit-de94', 'old': True}],
             'inbounds': [{'port': 18446}], 'routing': {'rules': [1]}, 'custom': ['keep']}
    ...
    def test_ssh_restrictions(self):
        ...
        self.assertEqual(p['PermitListen'], '127.0.0.1:34443')
        self.assertTrue(text.endswith('Match all\n'))
        self.assertIn('User=ham-rs633-de4\n', m.unit())
        self.assertIn('RemoteForward 127.0.0.1:34443 127.0.0.1:30443', m.client())
