...
class Tests(unittest.TestCase):
    def test_single_outbound_delta(self):
        c = {'outbounds': [{'tag': 'neighbor', 'settings': {'x': 1}}, {'tag': 'exit-pl150', 'old': True}],
             'inbounds': [{'port': 18444}], 'routing': {'rules': [1]}, 'custom': ['keep']}
    ...
    def test_ssh_restrictions(self):
        ...
        self.assertEqual(p['PermitListen'], '127.0.0.1:37443')
        self.assertTrue(text.endswith('Match all\n'))
        self.assertIn('User=ham-rs633-pl2\n', m.unit())
        self.assertIn('RemoteForward 127.0.0.1:37443 127.0.0.1:33443', m.client())
