...
req=urllib.request.Request(s['subscriptionUrl'],headers={'User-Agent':'mihomo/1.19.29','X-Hwid':'ham-rs633-pl2-owned-probe','X-Device-Os':'iOS','X-Device-Model':'Deployment probe','X-Ver-Os':'18'})
...
'''.replace('DIR', repr(op.DIR))
    ...
    proofs = []
    with tempfile.TemporaryDirectory(prefix='ham-pl2-mihomo-') as folder:
